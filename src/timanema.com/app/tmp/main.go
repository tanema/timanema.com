...
import (
	...
	tests0 "timanema.com/tests/mailers"
	tests1 "timanema.com/tests/mimes"
	tests2 "timanema.com/tests/models"
)
...
func main() {
	...
	revel.RegisterController((*controllers.Signature)(nil),
		[]*revel.MethodType{
			&revel.MethodType{
				Name: "Index",
				Args: []*revel.MethodArg{ 
	...
	revel.TestSuites = []interface{}{ 
		...
		(*tests0.UserMailerTest)(nil),
		(*tests1.PngMimeTest)(nil),
		(*tests2.SignatureModelTest)(nil),
	}
